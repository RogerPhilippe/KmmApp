package br.com.phs.shared.cache.shared

import br.com.phs.shared.cache.AppDatabase
import br.com.phs.shared.cache.AppDatabaseQueries
import br.com.phs.shared.cache.Launch
...
private class AppDatabaseQueriesImpl(
  ...
  public override fun <T : Any> selectAllLaunchesInfo(mapper: (
    ...
    articleUrl: String?
  ) -> T): Query<T> = Query(1272128045, selectAllLaunchesInfo, driver, "AppDatabase.sq",
  ...
  public override fun insertLaunch(
    ...
    notifyQueries(-758447853, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  public override fun removeAllLaunches(): Unit {
    driver.execute(-1191311273, """DELETE FROM Launch""", 0)
    notifyQueries(-1191311273, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }
}
